...
function runShaders() { Array.prototype.forEach.call(document.querySelectorAll('.hero-shader, .fx-shader'), initShader); }
...
gsap.to('.hero-content > :not(.cta-row):not(.subhead)', {
